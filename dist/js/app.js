 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".work-examples__slider")) new swiper_core_Swiper(".work-examples__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".swi")) new swiper_core_Swiper(".swi", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
        ...
        const handleMenuInteraction = (e, mediaQuery, targetItem, activeClass) => {
            if (window.matchMedia(mediaQuery).matches) {
                ...
                if (openMenu && openMenu !== targetElement) openMenu.classList.remove(activeClass);
                if (targetElement) {
                    targetElement.classList.add(activeClass);
                    if (targetElement === openMenu && e.type === "click") openMenu.classList.remove(activeClass);
                }
            }
        };
        document.addEventListener("click", (e => {
            const isSubMenu = e.target.closest("[data-submenu-drop]");
            if (isSubMenu) e.stopPropagation(); else handleMenuInteraction(e, "(max-width:1199.98px)", "[data-menu-drop]", "menu__item_open");
